...
export async function GET(req: NextRequest) {
  ...
  // Background: either the fetched image or a gradient fallback
  ...
  return new ImageResponse(
    (
      <div style={{ width: W, height: H, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '50px 62px', ...bgStyle }}>

        {/* Dark scrim over background */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(26,25,24,0.95) 40%, rgba(26,25,24,0.4) 70%, rgba(0,0,0,0.1) 100%)', width: W, height: H }} />
