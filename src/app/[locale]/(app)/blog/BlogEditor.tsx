                ...
                <div className="relative w-full aspect-[1200/630] rounded-xl overflow-hidden border border-zinc-200">
                  ...
                  <div className="absolute inset-0 flex items-end justify-center pb-5 px-5">
                    <div style={{width:"100%", display:"flex", flexDirection:"column", alignItems:"center"}}>
                      <p className="text-white font-black leading-tight" style={{textAlign:"center", fontSize: form.title_en.length > 80 ? 12 : form.title_en.length > 60 ? 15 : form.title_en.length > 40 ? 18 : 22, textShadow:'0 3px 16px rgba(0,0,0,1)'}}>
