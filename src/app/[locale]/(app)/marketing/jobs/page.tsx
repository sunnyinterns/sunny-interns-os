          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            {tab === 'visuels' && (
              <div className="max-w-3xl space-y-6">
                ...
                <div>
                ...
                </div><div className="bg-white rounded-2xl border border-zinc-100 p-5">
                  <div className="flex items-center justify-between mb-3">
                    <div><h3 className="text-sm font-bold text-[#1a1918]">🎬 Vidéo</h3><p className="text-xs text-zinc-400">Format carré 1080×1080 · 5 secondes · brand colors</p></div>
                  ...
                  {videoUrl ? (
                    <div className="flex items-center gap-3 p-3 bg-zinc-50 rounded-xl">
                      ...
                      <div className="flex-1"><p className="text-xs font-semibold">Vidéo générée ✅</p><p className="text-[10px] text-zinc-400">Format MP4 · {selected.public_title ?? selected.title}</p></div>
