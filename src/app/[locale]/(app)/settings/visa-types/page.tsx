      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-0.5">{visaTypes.length} visa{visaTypes.length !== 1 ? 's' : ''} configurés</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {visaTypes.map(v => (
              <div key={v.id} className="bg-white border border-zinc-100 rounded-xl px-5 py-4 flex items-start gap-4">
                ...
                <div className="text-right flex-shrink-0">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-medium mt-1 inline-block ${v.is_active ? 'bg-green-100 text-[#0d9e75]' : 'bg-zinc-100 text-zinc-500'}`}>
