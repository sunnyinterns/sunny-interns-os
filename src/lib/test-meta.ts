...
export const TEST_SUITES: SuiteMeta[] = [
  {
    ...
    tests: [
      ...
      { id: 'A5',  suite: 'A', file: '03-qualification.spec.ts',title: '/fr/en-attente → qualification',               description: 'Thomas ou engagement visible' },
      { id: 'A6',  suite: 'A', file: '03-qualification.spec.ts',title: 'Portail Thomas via portal_token',               description: 'Portal stagiaire accessible' },
