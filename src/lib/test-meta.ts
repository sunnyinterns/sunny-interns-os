...
export const TEST_SUITES: SuiteMeta[] = [
  {
    ...
    tests: [
      ...
      { id: 'A1',  suite: 'A', file: '01-lead.spec.ts',         title: '/fr/cases → Test Workflow visible',               description: 'Test Workflow au stade rdv_booked' },
      { id: 'A2',  suite: 'A', file: '01-lead.spec.ts',         title: 'Dossier Test Workflow charge sans 500',               description: 'Case ID fixe ffffffff-0001' },
      { id: 'A3',  suite: 'A', file: '01-lead.spec.ts',         title: '/fr/notifications → notifications',            description: 'Page notifications accessible' },
      { id: 'A4',  suite: 'A', file: '02-rdv.spec.ts',          title: 'Dossier Test Workflow → meet.google.com',                description: 'Lucas Bernard – lien Google Meet' },
      { id: 'A5',  suite: 'A', file: '03-qualification.spec.ts',title: '/fr/en-attente → Test Workflow',              description: 'Test Workflow – todo visible' },
      { id: 'A6',  suite: 'A', file: '03-qualification.spec.ts',title: 'Portail Test Workflow via portal_token fixe',              description: 'Token: ffffffff-0001...0099' },
